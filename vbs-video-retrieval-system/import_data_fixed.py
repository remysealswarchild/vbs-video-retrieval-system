# import_data_fixed.py
# Fixed version that doesn't rely on query_server module
...
DATASET_PATH = r"E:\image and video deep learning\vido project\vbs-video-retrieval-system\Dataset\V3C1-200" # change patath to your local path
